  ...
  const stats = [
    {
      ...
      sublabel: 'Active Students & Alumni',
    ...
    },
    {
      ...
      sublabel: 'Custom Jerseys & Owners',
      glow: 'group-hover:border-sky-500/30',
    },
    {
      icon: <Trophy className="h-5 w-5 text-[#E2C889]" />,
      value: DILMANLeagueStats.auctionCap.split(' ')[0],
      label: 'Virtual Purse Cap',
      sublabel: 'Per Franchise Auction',
      glow: 'group-hover:border-[#C5A059]/30',
    },
    {
